...
\begin{frame}{Feature of upmendex}
\renewcommand{\thefootnote}{$\dagger$}
  \begin{itemize}
  \item Index processor
    \begin{itemize}
    \item Upper compatible with MakeIndex/Mendex
...
\multirow{2}{*}{\LARGE{ᅀᅵᇙ〮} =~} & \Large ᅀ & \multirow{2}{*}{+} & \Large ᅵ & \multirow{2}{*}{+}& \Large ᇙ & \multirow{2}{*}{+} & \Large 〮 \\[2mm]
