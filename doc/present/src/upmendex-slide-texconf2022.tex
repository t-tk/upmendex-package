...
\begin{center}
  \includegraphics[scale=0.23]{Gojuon000.png}\\
  Katakana Letter Archaic YE =「\texttt{𛄡}」\\
  {\footnotesize defined in Unicode 14.0 (2021)}\\
\vskip1.5ex
\tiny
Ref. \url{http://www.unicode.org/L2/L2019/19381-missing-kana.pdf}\\
\url{https://dl.ndl.go.jp/info:ndljp/pid/993592}
\end{center}
...
\begin{center}
  ...
  \item Support more locales\\
     \begin{itemize}
      \item Latin: Sorbian, Hausa, Igbo, Yoruba, Kalaallisut, Breton, Uzbek
      \item etc.
     \end{itemize}
