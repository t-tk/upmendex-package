...
%
%
% Copyright (C) 2022-2025 TANAKA Takuji
...
मुंबई\index{मुंबई} % Mumbai
दिल्ली\index{दिल्ली} % Delhi
कोलकाता\index{कोलकाता} % Kolkata
कानपुर\index{कानपुर} % Kanpur
बंगलुरु\index{बंगलुरु} % Bengaluru
\end{hindi}
...
ঢাকা\index{ঢাকা} % Dhaka
চট্টগ্রাম\index{চট্টগ্রাম} % Chittagong
কলকাতা\index{কলকাতা} % Kolkata
\end{bengali}
...
சென்னை\index{சென்னை} % Chennai
கோயம்புத்தூர்\index{கோயம்புத்தூர்} % Coimbatore
மதுரை\index{மதுரை} % Madurai
\end{tamil}
...
హైదరాబాద్\index{హైదరాబాద్} % Hyderabad
విశాఖపట్నం\index{విశాఖపట్నం} % Visakhapatnam
అమరావతి\index{అమరావతి} % Amaravati
\end{telugu}
...
กรุงเทพมหานคร\index{กรุงเทพมหานคร} % Bangkok
นนทบุรี\index{นนทบุรี} % Nonthaburi
นครราชสีมา\index{นครราชสีมา} % Nakhon Ratchasima
เชียงใหม่\index{เชียงใหม่} % Chiang Mai
หาดใหญ่\index{หาดใหญ่} % Hat Yai
\end{thai}
